...
# A chamada a set_page_config deve ser a primeira instrução do app
st.set_page_config(page_title="Consumo Referencial", layout="centered")
...
# 3) Menu de navegação (ordem: Cálculo, Histograma, Sobre esse App, Sobre o Modelo Estatístico)
aba = st.sidebar.radio("Navegar para:", [
    "🧮 Cálculo do Consumo",
    "📊 Gerar Histograma Consumo",
    "ℹ️ Sobre esse App",
...
if aba == "🧮 Cálculo do Consumo":
    ...
    if st.session_state.df_consumo is not None:
        ...
        if st.button("Carregar outro arquivo CSV"):
            ...
            pass  # Removemos st.experimental_rerun() para evitar conflitos
    else:
        uploaded_file = st.file_uploader(
            "Faça o upload de um arquivo CSV (2 colunas: Mês, Consumo (m³))",
            type="csv",
...
# 6) Aba "ℹ️ Sobre esse App"
    ...
    # Conteúdo HTML incorporado com navegação entre páginas e MathJax para renderizar LaTeX
    html_content = """
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
    ...
    <body>
      ...
      <div class="page" id="page2">
        ...
        <ol>
          <li>
            <strong>Importações e Configurações:</strong> Importa bibliotecas como <code>pandas</code>, <code>numpy</code>, <code>matplotlib</code>, <code>seaborn</code> e configura a página com <code>st.set_page_config</code>.
          </li>
          <li>
